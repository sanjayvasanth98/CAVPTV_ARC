function parameters = parameters_CAVPTV(videoFile,optimizedParams)
   ...
   % Define sampleType
    ...
    parameters.xrayill = 5; % 1=Xray images 2=backlight images with particles 3=backlight images without particles 4= segementing bubbles from backlight videos, 5 = cloud cavitation
