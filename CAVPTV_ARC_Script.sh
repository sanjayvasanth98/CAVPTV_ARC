#!/bin/bash
#SBATCH --output=sporadic_SideView_%j.out
#SBATCH --error=sporadic_SideView_%j.err
...
# -------------------------------------------------------------------------
matlab -nodisplay -nosplash -nodesktop -batch "run('/home/kbsanjayvasanth/Inception_analysis/Videos/main_files/P10S100/main_code_smooth.m')"
